<?php 
    ...
    $tipos=mysqli_query($con, "select * from tipos_requerimientos ");
...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Tipo de Requerimientos</h1>
            <ol class="breadcrumb">
                <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                <li class="active">Tipo de Requerimientos</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <a class="btn btn-default pull-right" href="nuevo_requerimiento.php"><i class='fa fa-plus'></i> Nuevo</a>
                    <br><br>
                    <?php 
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="editar_requerimiento.php?id=<?php echo $area['id'] ?>"><i class="fa fa-pencil"></i> Editar</a></li>
