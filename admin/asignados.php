<?php 
    ...
    $atendidos=mysqli_query($con, "select * from tickets where status_id=2 && asigned_id!=0 order by id desc");
?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo "<span class='label label-info'>Asignado</span>
                                                "; ?></td>
                                    <td style="text-align: center;">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="incidencias.php?id=<?php echo $cat['id'] ?>"><i class="fa fa-ban"></i> Con Incidencia</a></li>
