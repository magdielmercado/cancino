<?php 
    ...
    include "header.php";
    include "sidebar.php";
    $puestos = mysqli_query($con, "select * from puesto");
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a class="btn btn-default pull-right" href="nuevo_puesto.php"><i class='fa fa-plus'></i> Nuevo</a>
                <br><br>
                 <?php 
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="editar_puesto.php?idpuesto=<?php echo $puesto['idpuesto'] ?>"><i class="fa fa-pencil"></i> Editar</a></li>
                                                <li><a href="action/delpuesto.php?idpuesto=<?php echo $puesto['idpuesto'] ?>"><i class="fa fa-trash"></i> Eliminar</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
