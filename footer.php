        ...
        <div class="modal fade" id="logout">
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <a type="button" class="btn btn-danger" href="action/logout.php">Si, Salir</a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2020 - <a href="https://cancinohidalgo.com/" target="_blank">Cancino Hidalgo</a>.</strong>
        </footer>
    </div><!-- ./wrapper -->
